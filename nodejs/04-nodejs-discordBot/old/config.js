module.exports = {
  ...
  // i.e: "-discord_boat foo" will trigger the command "foo",
  //      whereas "Discord_Boat foo" will do nothing at all.
  prefix:  "!d",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "MjkxMTE4MzQ0OTI3NTc2MDY0.C6k0vA.mgLr6ETr7aA24INpLQHKaTqpcVA",
