...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractEarthquakes(String earthquakeJSON) {
        ...
        //
        //
        //  TODO THE BUG IS SOMETHING WITH THIS STATIC LIST !?!?
        // List is always null ?!!
        //

        System.out.println("this is a print that really should work");
        ...
        try {
            ...
            JSONArray features = rootJson.getJSONArray("features");
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                int s = place.indexOf("of ");

                String placeCountry = null;
                String distanceOf = null;

                if (s != -1) {
                    placeCountry = place.substring((s + 3), length);
                    distanceOf = place.substring(0, (s + 2));
                    System.out.println(distanceOf);
                    System.out.println(placeCountry);
                } else if (s == -1) {
                    distanceOf = "Near the";
                    placeCountry = place;
                    System.out.println(distanceOf);
                ...
                earthquakes.add(new Earthquake(mag, distanceOf, placeCountry, time, url));
